...
- [Architecture](/architecture) — system layers, data flow, key design decisions, performance targets
- [Relationship Graph](/relationship-graph) — knowledge graph, auto-linking, graph-augmented reranking

## Contributing guides

- [Testing](testing.md) — testing contract, how to run checks, what makes a good core-subsystem test
